  ...
  hover:scale-110 active:scale-90 ${todo.completed ? "bg-linear-to-br from-emerald-400 to-teal-500 border-emerald-400 shadow-lg shadow-emerald-400/50" : "border-white/30 hover:border-violet-400 hover:bg-violet-400/20 active:border-violet-400 active:bg-violet-400/30"}`}>
        ...
        <div className='flex gap-1 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-all duration-300 sm:translate-x-2 sm:group-hover:translate-x-0'>
          {isEditing ? (<>
            ...
            <button onClick={() => onDelete(todo.id)} className='w-7 h-7 rounded-lg bg-rose-600/10 text-rose-300 hover:bg-rose-500 hover:text-white transition-all duration-300 flex items-center justify-center transform hover:scale-110 active:scale-95 border border-rose-500/30'>
              <Trash2 size={14} />
            </button>
